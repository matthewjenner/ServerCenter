...
> support and S3 backup are intentionally deferred. Version `0.1.20`.
...
curl -L -O https://github.com/matthewjenner/ServerCenter/releases/download/agent-v0.1.20/servercenter-agent-0.1.20-linux-x64.tar.gz
mkdir agent && tar -xzf servercenter-agent-0.1.20-linux-x64.tar.gz -C agent && cd agent
